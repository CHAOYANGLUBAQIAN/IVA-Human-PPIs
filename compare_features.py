...
datasets = ['data/features/AAC.csv', 'data/features/APAAC.csv', 'data/features/CT.csv', 'data/features/CTDC.csv', 'data/features/CTDT.csv',
'data/features/CTDD.csv','data/features/Geary.csv','data/features/Moran.csv','data/features/PAAC.csv','data/features/QSO.csv','data/features/SOCN.csv']
...
results_df.to_csv('data/results/Results_of_feature_comparisons.csv', index=False)
